...
contract IfYouGetHereThereIsAStorageCollision {}
...
contract FeeDistributor is
    ...
    IVersioned
{
    IfYouGetHereThereIsAStorageCollision private _storageCollision;
    ...
    function addCurrency(address _currency) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "only admin can add currency");
        _requireNotPaused();
