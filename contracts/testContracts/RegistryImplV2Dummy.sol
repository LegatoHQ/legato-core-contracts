...
import "../Cloner.sol";
import "contracts/registries/RegistryStorageLayout.sol";
//import rootregistry
import "../dataBound/RootRegistry/RootRegistry.sol";
import "lib/openzeppelin-contracts-upgradeable/contracts/access/AccessControlUpgradeable.sol";

contract RegistryImplV2Dummy is
    ...
    IVersioned
{
    ...
    function initialize(string memory _name, address _ownerWallet, address _eternalStorage, uint256 _nonce)
        ...
        override
    {
        // console.log("RegistryImplV1.initialize,startin", _name, _ownerWallet, _eternalStorage);
        ...
        // console.log("granting admin role to root registry");
        ...
        // console.log("granting store owner role to ", _ownerWallet);
    ...
    function mintLicense(MintLicenseRequest memory req) external override isInitialized onlyActive returns (uint256) {
        ...
        require(address(licenseContract) != address(0), "registryv2 - license not attached ");
        VerifyHelper helper = VerifyHelper(getAddressManager().getVerifyHelper());
    ...
    function detachStore() external override onlyStoreOwner {
        // RootRegistry(getAddressManager().getRootRegistry()).delistStore(address(this), ownerWallet);
